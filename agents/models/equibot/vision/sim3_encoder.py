...
from agents.models.equibot.vision.vec_pointnet import VecPointNet
...
class SIM3Vec4Latent(nn.Module):
    ...
    def __init__(
        ...
        self.backbone = BACKBONE_DICT[backbone_type](**backbone_args).to(device)
        self.fc_inv = VecLinear(c_dim, c_dim, mode=mode, device=device)
