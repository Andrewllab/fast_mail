...
from agents.mdt.utils.clip_tokenizer import SimpleTokenizer as _Tokenizer
...
__all__ = ["available_models", "load_clip", "tokenize"]
...
class CLIP(nn.Module):
    def __init__(
        ...
        if isinstance(vision_layers, (tuple, list)):
            ...
            self.visual = VisionTransformer(  # type: ignore
                input_resolution=image_resolution,
...
def build_model(state_dict: dict) -> Any:
