...
class DepthAI(DiscreteCamera):
    ...
    This class inherits its functions from `environments.real_robot.hardware.hardware_devices.DiscreteDevice`.
    """
    ...
    def get_devices(
        ...
        super(DepthAI, DepthAI).get_devices(
            amount, height=height, width=width, type="DepthAI", **kwargs
        )
