...
class Azure(DiscreteCamera):
    ...
    This class inherits its functions from `environments.real_robot.hardware.hardware_cameras.DiscreteCamera`.
    """
    ...
    def get_devices(
        ...
        super(Azure, Azure).get_devices(
            amount, height=height, width=width, type="Azure", **kwargs
        )
        cams = []
