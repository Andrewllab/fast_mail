...
class KatTokenizer(Transform, nn.Module):
    """
    ...
    def __init__(
        ...
        self.token_type_embedding = nn.Embedding(100, embed_dim)
    ...
    def __tokenize_pcd(self, pcd: TensorDict, is_action: bool) -> Tensor:
        ...
        # Features
        feature_embed = self.feature_encoder(features)  # (B, N_non_grip, D)
