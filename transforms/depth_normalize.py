...
class DepthNormalize(NormalizingTransform):
    ...
    def __init__(
        ...
        self._input_specs = {
            ...
            and any(isinstance(s, DepthStream) for s in spec.streams.values())
        }
    ...
    def reverse(self, tensordict: TensorDict) -> TensorDict:
        # no need to reverse a normalization on the observation
        return tensordict
