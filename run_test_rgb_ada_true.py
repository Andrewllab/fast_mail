...
def main(cfg: DictConfig) -> None:
    ...
    agent.load_pretrained_model(f'/hkfs/work/workspace/scratch/ll6323-david_dataset_2/weights/rgb_ada_true/obs_encoders=pretrained_resnet_film,agents=beso_agent,group=beso_encoder_decoder,seed={cfg.seed},xlstm_decoder_adaLN_zero=True,xlstm_decoder_vocab_size=10',
                                sv_name='last_model')
